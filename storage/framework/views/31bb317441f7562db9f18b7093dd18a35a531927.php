...
<div class="container">
    ...
    <?php if($userPendingProducts->count() >=1): ?>
    <div class="row user-profiles">
        <div class="col s12 m3 l3 profile">
            <p class="profile__heading text-grey darken-3">Pending Subscriptions</p>
            <p><i class="small material-icons pink-text lighten-4">looks</i></p>
            <span class="profile__user-name"><?php echo e($user->pendingProducts($user->id)); ?></span>
            <span class="profile__user-name"></span>
        ...
        <div class="col s12 m9 l9  profile-detail">
            ...
            <table class="highlight">
                ...
                <tbody>
                    <?php $__currentLoopData = $userPendingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($product->product->name); ?></td>
                        <td><?php echo e($product->units); ?></td>
                        <td><?php echo e(number_format($product->product->unit_cost,2,'.',',')); ?></td>
                        <td><?php echo e(number_format($product->total_amount,2,'.',',')); ?></td>
                        <td><?php echo e(number_format($product->net_pay,2,'.',',')); ?></td>
                        <td><a href="/prodSub/review/<?php echo e($product->id); ?>">Review</a> <a
                                href="/userProdSub/delete/<?php echo e($product->id); ?>">Discard</a> </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
    ...
    <?php else: ?> <?php endif; ?> <?php if($userProducts->count() >=1): ?>
    <div class="row user-profiles">
        <div class="col s12 m3 l3 profile">
            <p class="profile__heading text-grey darken-3">Active Subscriptions</p>
            <p><i class="small material-icons pink-text lighten-4">looks</i></p>
            <span class="profile__user-name"><?php echo e($user->activeProductSub($user->id)); ?></span>
            <span class="profile__user-name"></span>
        ...
        <div class="col s12 m9 l9 blue lighten-4  profile-detail">
            ...
            <table class="highlight">
                ...
                <tbody>
                    <?php $__currentLoopData = $userProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $myProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($myProduct->product->name); ?></td>
                        <td><?php echo e(number_format($myProduct->total_amount,2,'.',',')); ?></td>
                        <td><?php echo e(number_format($myProduct->totalSubDeductions($myProduct->id),2,'.',',')); ?></td>
                        <td><?php echo e(number_format($myProduct->total_amount-$myProduct->totalSubDeductions($myProduct->id),2,'.',',')); ?>

                        </td>
                        <td><a href="/product/repay/<?php echo e($myProduct->id); ?>">Repay</a> <a
                                href="/prodSub/stop/<?php echo e($myProduct->id); ?>">Stop</a></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
