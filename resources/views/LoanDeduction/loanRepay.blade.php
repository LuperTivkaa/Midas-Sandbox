...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 subject-header">
            <h5 class="teal-text">LOAN REPAYMENT</h5>
        </div>
    </div>
    <div class="row">
        <div class="col s12 subject-header">
        ...
        <form class="col s12" method="POST" action="/loanRepay/store">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    <input disabled id="payment_id" name="payment_id" value="{{$subscription->user->payment_number}}"
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6 l6">
                    <select id="product" name="product">
                        <option value="{{$subscription->loan->id}}">{{$subscription->loan->description}}</option>
                    </select>
