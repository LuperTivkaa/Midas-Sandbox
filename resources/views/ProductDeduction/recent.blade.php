...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 subject-header">
            ...
            <span><a href="{{route('prod-deductions.upload')}}"><i class="small material-icons tooltipped" data-position="bottom" data-tooltip="New Savings Upload">cloud_upload</i></a></span>
        </div>
    </div>
            ...
            <table class="highlight">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/productDeduction/detail/{{$item->id}}">{{number_format($item->monthly_deduction,2,'.',',')}}</a></td>
                        ...
                        <td>
                            <a href="/productDeduction/remove/{{$item->id}}" id="delete"> <i class="small material-icons red-text">delete</i></a>
                        </td>
