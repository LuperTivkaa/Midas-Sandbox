...
<div class="row">
    ...
    <div class="col-sm-12  col-md-6 col-lg-6 mb-3 text-center">
        ...
        <div class="card text-center">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/andy.jpg')}}" alt="Card image cap">
...
<div class="row">
    <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
        ...
        <div class="card">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/sesugh.jpg')}}" alt="Card image cap">
            <div class="card-body text-center">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
        <div class="card">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/edigah.jpg')}}" alt="Card image cap">
            <div class="card-body text-center">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
        <div class="card">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/ternenge.jpg')}}" alt="Card image cap">
            <div class="card-body text-center">
...
<div class="row">
    <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
        <div class="card">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/apaa.jpg')}}" alt="Card image cap">
            <div class="card-body text-center">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
        <div class="card">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/uche.jpg')}}" alt="Card image cap">
            <div class="card-body text-center">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
        <div class="card">
            <img class="card-img-top img-fluid cards-img" src="{{asset('images/eronini.jpg')}}" alt="Card image cap">
            <div class="card-body text-center">
