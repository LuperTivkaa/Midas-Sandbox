...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 subject-header">
            <h5 class="teal-text">CREATE PRODUCT REPAYMENT</h5>
        </div>
    </div>
    <div class="row">
        <div class="col s12 subject-header">
    ...
    <div class="row">
        <form class="col s12" method="POST" action="/productRepay/store">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m4 l4">
                    <input id="depositor_name" name="depositor_name" type="text">
                    <label for="depositor_name">Depositor Name</label>
                </div>
                <div class="input-field col s12 m4 l4">
                    <input id="teller_number" name="teller_number" type="text">
