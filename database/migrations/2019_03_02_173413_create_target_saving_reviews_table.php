...
class CreateTargetSavingReviewsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('target_saving_reviews', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('target_saving_reviews');
    }
}
