...
class DashboardController extends Controller
{
    ...
    public function index (){
     ...
     public function printStatement($from,$to){
        ...
        return view('Prints.myPrint',compact('title','Saving','from','to','statementCollection'));
    }
    ...
    public function downloadStatement($from,$to){
        ...
        $pdf = PDF::loadView('Prints.saving-statement',compact('Saving','title','statementCollection','from','to'));
        return $pdf->download('savingstatement.pdf');
...
public function productDetails($id)
    {
        ...
        $user_id = auth()->id();
        $products = Psubscription::find($id);
...
return view('Dashboard.productDeductions',compact('deductions','title'));   
    ...
    public function customSearch(Request $request){
           ...
           $title = 'Filtered Records';
            ...
            return view ('Dashboard.searchSaving',compact('title','records','fromDate','toDate','saving'));
