...
<div class="user-profiles">
    <div class="profile">
        <div class="myloandetail">
            ...
            <span>Total Amount: {{number_format($products->total_amount,2,'.',',')}}</span>
            <span>Monthly Payment: {{number_format($products->monthly_repayment,2,'.',',')}}</span>
        </div>
    </div>
</div>
...
<div class="user-profiles">
    <div class="profile">
        <div class="myloandetail">
            ...
            <span>Status: {{$products->product->status}}</span>
            <span>Start Date:
